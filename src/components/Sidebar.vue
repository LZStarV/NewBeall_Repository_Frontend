        ...
        <div class="brand-header">
            <div class="brand-content">
                ...
                <div v-show="collapsed" class="brand-logo">
                    <img src="@/assets/image/default/cover_logo.png" alt="Newbeall Logo" class="logo-img-collapsed" />
                </div>
            </div>
        </div>
                    ...
                    <template v-for="menuItem in menuStructure" :key="menuItem.key">
                        ...
                        <div v-if="!menuItem.hasSubmenu" class="menu-item"
                            ...
                            <div v-show="!collapsed && menuItem.key === 'order-approval' && hasNewOrders"
                                class="notification-badge">1</div>
                        </div>
                        ...
                        <div v-else class="menu-group">
                            <div class="menu-item submenu-title" @click="toggleSubmenu(menuItem.key)">
                                ...
                                <div v-show="!collapsed && menuItem.key === 'order-approval' && hasNewOrders"
                                    class="notification-badge">1</div>
                                <lay-icon v-show="!collapsed" type="layui-icon-right" class="arrow-icon"
                                    :class="{ expanded: submenuOpen[getSubmenuKey(menuItem.key)] }" />
                            </div>
                            <div v-show="!collapsed && submenuOpen[getSubmenuKey(menuItem.key)]" class="submenu">
...
import { ROUTE_CONFIG_MAP, MENU_STRUCTURE, getRouteKeyByPath, type RouteConfig } from '@/utils/routeConfig';

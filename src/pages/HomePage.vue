            ...
            <div class="info-card">
              <div class="card-header">
                ...
                <div class="card-actions">
                  ...
                  <lay-icon type="layui-icon-more-vertical" class="action-icon" />
                </div>
              </div>
              <div class="card-content">
                <div class="note-list">
              ...
              <div class="card-content">
                <div class="member-list">
                  <div class="member-item all-members">
                     <lay-checkbox name="like" skin="primary" value="1">全选</lay-checkbox>
                  </div>
                  <div
...
.chart-container {
  ...
  .pie-placeholder, .chart-placeholder {
    width: 100%;
    height: 150px;
